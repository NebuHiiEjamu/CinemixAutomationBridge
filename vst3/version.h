...
#define stringPluginName		"Automation Bridge"

#define stringOriginalFilename	"AutomationBridge.vst3"
#if SMTG_PLATFORM_64
#define stringFileDescription	stringPluginName" VST3-SDK (64Bit)"
#else
#define stringFileDescription	stringPluginName" VST3-SDK"
#endif
#define stringCompanyName		""
#define stringCompanyWeb		"https://github.com/NebuHiiEjamu/CinemixAutomationBridge"
#define stringCompanyEmail		"mailto:cmmeurin@gmail.com"

#define stringLegalCopyright	"© 2019"
